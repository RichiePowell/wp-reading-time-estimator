...
A plugin that estimates and displays reading time for WordPress posts.
...
= How do I display the reading time manually? =

Use the `[reading_time]` shortcode in your post content to manually display the reading time.

= Can I disable automatic insertion? =

Yes, you can disable automatic insertion in the plugin settings.